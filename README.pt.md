...
![Fluxo de conexão DSH Mobile Mesh](assets/mesh-connection.svg)
...
Versão testada: [dsh-v0.1.5-alpha.2](https://github.com/deepseek-ai/deepseek-harness/tree/dsh-v0.1.5-alpha.2), pacote `0.1.5-rc.2`.
